...
class C_Action:
    ...
    def input_start_time(self,stime):
        ti = self.driver.find_element_by_xpath('//*[@id="course"]/div[1]/input[1]')
        Service.send_input(ti,stime)

    # 输入查询结束时间
    def input_endtime_time(self, etime):
        ti = self.driver.find_element_by_xpath('//*[@id="course"]/div[1]/input[2]')
        Service.send_input(ti, etime)
